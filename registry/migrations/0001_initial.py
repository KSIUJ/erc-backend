    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', registry.models.NullCharField(max_length=128, unique=True, validators=[django.core.validators.EmailValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('CARD', 'Card'), ('LDAP', 'LDAP'), ('DISCORD', 'Discord'), ('EMAIL', 'Email')], default='CARD', max_length=10)),
